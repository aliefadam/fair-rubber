...
@section('content')
    ...
    <form action="{{ route('admin.transaction.rubber-collected.store') }}" method="POST" id="formRubberCollected">
        ...
        <div class="bg-white dark:bg-slate-800 shadow-md rounded-lg p-5">
            ...
            <div class="grid grid-cols-2 gap-7">
                ...
                <div class="mb-5">
                    ...
                    <input type="date" id="tanggal_penimbangan_pabrik" name="tanggal_penimbangan_pabrik"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                </div>
            </div>
        ...
        <div class="mt-5">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg" id="table"></div>
    ...
    <script>
        ...
        function submitForm(e) {
            ...
            const data = {
                ...
                toleransi_timbangan: +toleransiTimbangan,
