...
@section('content')
    ...
    <form action="{{ route('admin.master.collector.updateFarmer', $farmer->id) }}" method="POST"
            ...
            <div class="">
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-3 flex items-center gap-3">
                        <div class="flex items-center">
                            <input @checked($farmer->gender == 'M') id="default-radio-1" type="radio" value="M"
                                name="gender"
                        ...
                        <div class="flex items-center">
                            <input @checked($farmer->gender == 'F') id="default-radio-2" type="radio" value="F"
                                name="gender"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="mb-5">
                    ...
                    <select id="provinsi" name="provinsi"
                        ...
                        <option @selected($farmer->province_id == 1) value="1">Jawa Timur</option>
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <select id="kabupaten_kota" name="kabupaten_kota"
                        ...
                        <option @selected($farmer->city_id == 1) value="1">Kota Surabaya</option>
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <select id="kecamatan" name="kecamatan"
                        ...
                        <option @selected($farmer->district_id == 1) value="1">Benowo</option>
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <select id="Kelurahan" name="kelurahan"
                        ...
                        <option @selected($farmer->sub_district_id == 1) value="1">Sememi</option>
                    </select>
                </div>
                <div class="mb-5">
            ...
            <div class="">
                <div class="mb-5">
                    ...
                    <input type="date" id="anggota_sejak" name="anggota_sejak"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="name@flowbite.com" required value="{{ $farmer->date_of_join }}" />
                </div>
                <div class="mb-5">
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-3 flex items-center gap-3">
                        <div class="flex items-center">
                            <input @checked($farmer->ownership_garden == 'Milik Sendiri') id="milik-sendiri" type="radio" value="Milik Sendiri"
                        ...
                        <div class="flex items-center">
                            <input @checked($farmer->ownership_garden == 'Orang Lain') id="orang-lain" type="radio" value="Orang Lain"
                                name="kepemilikan_kebun"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center">
                            <input @checked($farmer->ownership_garden == 'Sewa Lahan') id="sewa-lahan" type="radio" value="Sewa Lahan"
                                name="kepemilikan_kebun"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="mb-5">
                    ...
                    <select id="bank" name="bank"
                        ...
                        <option @selected($farmer->bank_name == 'BCA') value="BCA">BCA</option>
                        <option @selected($farmer->bank_name == 'BNI') value="BNI">BNI</option>
                        <option @selected($farmer->bank_name == 'BRI') value="BRI">BRI</option>
                    </select>
                </div>
                <div class="mb-5">
