...
@section('content')
    ...
    <form action="{{ route('admin.master.collector.update', $collector->id) }}" method="POST"
        class="bg-white dark:bg-slate-800 shadow-md rounded-lg p-5">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-2 gap-7">
            <div class="">
                <div class="mb-5">
                    ...
                    <input type="text" id="kode" name="kode" disabled
                ...
                <div class="mb-6">
                    ...
                    <div class="mt-3 flex items-center gap-3">
                        <div class="flex items-center">
                            <input @checked($collector->gender == 'M') id="default-radio-1" type="radio" value="M"
                                name="gender"
                        ...
                        <div class="flex items-center">
                            <input @checked($collector->gender == 'F') id="default-radio-2" type="radio" value="F"
                                name="gender"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="mb-5">
                    ...
                    <select id="provinsi" name="provinsi"
                        ...
                        <option @selected($collector->province_id == 1) value="1">Jawa Timur</option>
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <select id="kabupaten_kota" name="kabupaten_kota"
                        ...
                        <option @selected($collector->city_id == 1) value="1">Kota Surabaya</option>
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <select id="kecamatan" name="kecamatan"
                        ...
                        <option @selected($collector->district_id == 1) value="1">Benowo</option>
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <select id="Kelurahan" name="kelurahan"
                        ...
                        <option @selected($collector->sub_district_id == 1) value="1">Sememi</option>
                    </select>
                </div>
                <div class="mb-5">
                ...
                <div class="mb-5">
                    ...
                    <textarea
                        ...
                        name="alamat" id="" cols="30" rows="3">{{ $collector->address }}</textarea>
                </div>
            </div>
            <div class="">
                <div class="mb-5">
                    ...
                    <input type="date" id="anggota_sejak" name="anggota_sejak"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="name@flowbite.com" required value="{{ $collector->date_of_join }}" />
                </div>
                <div class="mb-5">
                    ...
                    <input type="number" id="jumlah_kebun" name="jumlah_kebun"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $collector->number_of_garden }}" />
                </div>
                <div class="mb-5">
                    ...
                    <input type="number" id="luas_kebun" name="luas_kebun"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $collector->size_of_garden }}" />
                </div>
                <div class="mb-5">
                    ...
                    <input type="number" id="jumlah_pohon" name="jumlah_pohon"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $collector->number_of_tree }}" />
                </div>
                <div class="mb-5">
                    ...
                    <input type="number" id="hasil_panen_seminggu" name="hasil_panen_seminggu"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $collector->weekly_harvest }}" />
                </div>
                <div class="mb-6">
                    <label for="gender" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Kepemilikan Kebun
                    ...
                    <div class="mt-3 flex items-center gap-3">
                        <div class="flex items-center">
                            <input @checked($collector->ownership_garden == 'Milik Sendiri') id="milik-sendiri" type="radio" value="Milik Sendiri"
                                name="kepemilikan_kebun"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="milik-sendiri"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Milik Sendiri</label>
                        </div>
                        <div class="flex items-center">
                            <input @checked($collector->ownership_garden == 'Orang Lain') id="orang-lain" type="radio" value="Orang Lain"
                                name="kepemilikan_kebun"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="flex items-center">
                            <input @checked($collector->ownership_garden == 'Sewa Lahan') id="sewa-lahan" type="radio" value="Sewa Lahan"
                                name="kepemilikan_kebun"
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div class="mb-5">
                    ...
                    <select id="bank" name="bank"
                        ...
                        <option @selected($collector->bank_name == 'BCA') value="BCA">BCA</option>
                        <option @selected($collector->bank_name == 'BNI') value="BNI">BNI</option>
                        <option @selected($collector->bank_name == 'BRI') value="BRI">BRI</option>
                    </select>
                </div>
                <div class="mb-5">
                    ...
                    <input type="number" id="no_rekening" name="no_rekening"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $collector->account_number }}" />
                </div>
                <div class="mb-5">
                    ...
                    <input type="text" id="nama_rekening" name="nama_rekening"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $collector->account_name }}" />
                </div>
                <div class="flex justify-end">
                    <button type="submit"
                        class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Simpan</button>
                </div>
            </div>
        </div>
    </form>
